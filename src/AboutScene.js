var AboutScene = new Phaser.Class({
  ...
  create: function () {
    ...
    this.add.text(40, 100, 'One day, two dudes decided to make', {fontFamily: 'Arial', fontSize: 16, color: '#ffffff'});
    this.add.text(40, 120, 'a game....', {fontFamily: 'Arial', fontSize: 16, color: '#ffffff'});
